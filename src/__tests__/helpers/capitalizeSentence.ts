...
describe('capitalizeSentence helper function', () => {
  ...
  test('should capitalize first letters in strings with dots', () => {
    expect(capitalizeSentence('Do this. do that')).toBe('Do this. Do that')
    expect(capitalizeSentence('do this...do that')).toBe('Do this...Do that')
  })

  test('should capitalize first letters in strings with question marks', () => {
    expect(capitalizeSentence('do this? do that?')).toBe('Do this? Do that?')
  })

  test('should capitalize first letters in strings with exclamation marks', () => {
    expect(capitalizeSentence('do this! do that')).toBe('Do this! Do that')
  })
